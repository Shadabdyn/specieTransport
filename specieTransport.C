...
{
    defineTypeNameAndDebug(specieTransport, 0);
...
Foam::tmp<Foam::volScalarField> Foam::functionObjects::specieTransport::D
(
...
) const
{
    ...
    dimensionedScalar Dw( "Dw", dimensionSet(0, 2, -1, 0, 0, 0, 0), Dw_);
...
Foam::functionObjects::specieTransport::specieTransport
(
    const word& name,
    const Time& runTime,
...
bool Foam::functionObjects::specieTransport::read(const dictionary& dict)
{
    ...
    Dw_ = dict.lookupOrDefault("Dw", 1.0);
...
bool Foam::functionObjects::specieTransport::execute()
{
...
bool Foam::functionObjects::specieTransport::write()
{
    return true;
}
